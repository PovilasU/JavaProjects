...
public class Task2_1 {
    ...
    public static void main(String[] args) throws Exception // throws Exception is used to prevent more errors
    {
        ...
        FileReader file = new FileReader("sonnet1-b.txt");
        ...
        try {
            ...
            while (readFile.hasNext())//keep reading until there is nothing exists
            {
                ...
                if (currentWord.contains("\'")) {
                    ...
                    counterOpostroph = counterOpostroph + 1;

                } else {
                    collectionOfWords.add(currentWord);
                }

                if (currentWord.replaceAll("[?,(:.\'!);]", "").length() % 2 == 0) {
        ...
        System.out.println("There were " + collectionOfWords.size() + " words and " + (counterChar - counterOpostroph) + " letters.");
        System.out.println("There were " + collectionEvenWords.size() + " even words, " + "and " + collectionOddWords.size() + " odd words.");
        
        output.println("File analysed: sonnet1-b.txt");
        output.println("There were " + collectionOfWords.size() + " words and " + (counterChar - counterOpostroph) + " letters.");
        ...
        output.println();
        output.println("\n\r" + "Collection of unique words with odd number of letters: ");
